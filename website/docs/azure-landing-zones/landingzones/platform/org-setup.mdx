...
The [platform starter project is here](https://github.com/aztfmod/caf-terraform-landingzones-platform-starter).
...
### Clone the Azure Terraform SRE code
...
```bash
git clone https://github.com/aztfmod/caf-terraform-landingzones.git landingzones
```
...
Latest features on Azure Terraform SRE repository are released on regular basis. In order to align the deployment instructions, you need to make sure the Terraform code is also using the correct branch or tag.Please check the latest tag from the landingzones repo at https://github.com/aztfmod/caf-terraform-landingzones/releases .
