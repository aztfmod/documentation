...
# Introduction to the Azure Terraform SRE rover

<ReactPlayer controls url='https://www.youtube.com/embed/2px14Zajr0k' />

## What is Azure Terraform SRE rover?

Although as a first approach it might seem more natural and simple to use Terraform on your laptop, the Azure Terraform SRE **rover** is helping you managing your Terraform deployments on Microsoft Azure and has two dimensions:
...
## Why using Azure Terraform SRE rover?
...
## Where to find Azure Terraform SRE rover?
...
## How to use Azure Terraform SRE rover?

Rover is already included in development environment for Azure Terraform SRE Terraform (the ```.devcontainer``` folder in the various projects).
