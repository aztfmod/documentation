...
```bash
git checkout 2203.0
Branch '2203.0' set up to track remote branch '2203.0' from 'origin'.
Switched to a new branch '2203.0'
➜  landingzones git:(2203.0) ✗ 
```

:::note
The branch name in parentheses has changed from **main** to **2203.0**
:::
