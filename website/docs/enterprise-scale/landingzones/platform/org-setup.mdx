...
Branch 'aci_network' set up to track remote branch 'aci_network' from 'origin'.
Switched to a new branch 'aci_network'
➜  landingzones git:(aci_network) ✗ 
```

:::note
The branch name in parentheses has changed from **main** to **aci_network**
:::
